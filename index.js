...
client.on("ready", () => {
  ...
  client.user.setActivity(`Invading ${client.guilds.size} servers`);
});
...
client.on("message", async message => {
  ...
  if(message.guild == null) {
    ...
    if(message.content.toLowerCase() == "just monika" | message.content.toLowerCase() == "only monika") {
        message.channel.send("YES ONLY MEE!\n\n```⣼⣯⠄⣸⣠⣶⣶⣦⣾⠄⡅⡅⠄⠄⠄⠄⡉⠹⠄⡅⠄⠄⠄\n" +
        "⠿⠿⠶⠿⢿⣿⣿⣿⣿⣦⣤⣄⢀⡅⢠⣾⣛⡉⠄⠄⠄⠸⢀\n" +
        "⣴⣶⣶⡀⠄⠄⠙⢿⣿⣿⣿⣿⣿⣴⣿⣿⣿⢃⣤⣄⣀⣥⣿\n" +
        "⣿⣿⣿⣧⣀⢀⣠⡌⢻⣿⣿⣿⣿⣿⣿⣿⣿⣿⠿⠿⠿⣿⣿\n" +
        "⣤⣤⣤⣬⣙⣛⢿⣿⣿⣿⣿⣿⣿⡿⣿⣿⡍⠄⠄⢀⣤⣄⠉\n" +
